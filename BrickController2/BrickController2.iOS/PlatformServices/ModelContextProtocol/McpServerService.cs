...
internal class McpServerService : InputDeviceServiceBase<McpServerDevice>, IMcpServerService, IDisposable
{
    ...
    public McpServerService(IInputDeviceManagerService inputDeviceManagerService,
        ...
        McpServerBonjourPublisher mcpServerBonjourPublisher)
    ...
    public override void Initialize()
    {
        ...
        if (_server != null)
        {
            AddInputDevice(new McpServerDevice(InputDeviceEventService, _server));
        }
    }
    ...
    private void ApplyMcpServer()
    {
        lock (_Lock)
        {
            // dispose existing server and stop bonjour publisher
            if (_server != null)
            {
                _server?.Dispose();
                _server = null;
