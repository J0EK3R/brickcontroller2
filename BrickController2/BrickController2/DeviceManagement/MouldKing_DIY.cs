...
namespace BrickController2.DeviceManagement
{
  ...
  internal class MouldKing_DIY : BluetoothDevice
  {
    ...
    #region MouldKing_DIY(string name, string address, byte[] deviceData, IDeviceRepository deviceRepository, IBluetoothLEService bleService)
    /// <summary>
    /// 
    /// </summary>
    ...
    public MouldKing_DIY(string name, string address, byte[] deviceData, IDeviceRepository deviceRepository, IBluetoothLEService bleService)
