...
namespace BrickController2.DeviceManagement
{
  ...
  internal class XPBlock_XC5 : BluetoothDevice
  {
    ...
    #region XPBlock_XC5(string name, string address, byte[] deviceData, IDeviceRepository deviceRepository, IBluetoothLEService bleService)
    /// <summary>
    /// 
    /// </summary>
    ...
    public XPBlock_XC5(string name, string address, byte[] deviceData, IDeviceRepository deviceRepository, IBluetoothLEService bleService)
